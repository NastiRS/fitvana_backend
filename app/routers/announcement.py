...
def create_announcement(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Ocurrió un error al crear el anuncio: {str(e)}",
        )
...
def update_announcement(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Ocurrió un error al actualizar el anuncio: {str(e)}",
        )
...
def delete_announcement(announcement_id: uuid.UUID, repo: CurrentAnnouncementRepo):
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Ocurrió un error al eliminar el anuncio: {str(e)}",
        )
    return None
...
def add_announcement_to_blog_post(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Ocurrió un error al agregar el anuncio al blog post: {str(e)}",
        )
...
def remove_announcement_from_blog_post(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Ocurrió un error al eliminar el anuncio del blog post: {str(e)}",
        )
...
def get_blog_posts_for_announcement(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Ocurrió un error al obtener los blog posts del anuncio: {str(e)}",
        )
